...
const WHATSAPP_NUMBER = '38345400907'; // +383 45 400 907, same number used in the Footer
...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 sm:bottom-auto sm:top-1/2 sm:-translate-y-1/2 right-5 z-[90] w-14 h-14 rounded-full bg-[#25D366] shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 flex items-center justify-center"
    >
