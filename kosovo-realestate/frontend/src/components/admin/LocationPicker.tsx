...
const PIN_ICON = L.icon({
  iconUrl:
    ...
    btoa(
      '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="42" viewBox="0 0 32 42"><path d="M16 0C7.163 0 0 7.163 0 16c0 11 16 26 16 26s16-15 16-26C32 7.163 24.837 0 16 0z" fill="#C4275C"/><circle cx="16" cy="16" r="7" fill="#fff"/></svg>'
    ),
  iconSize: [32, 42],
  iconAnchor: [16, 42],
});
